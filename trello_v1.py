...
import sys
######################################################################
#  Програма попросит ввести ваши key token короткий ID вашей доски   #
######################################################################

# Запрос у пользователя данных
def auth_data():
    print("Подготоьте данные для авторизации в Trello,")
    print("вам понадобятся key, token и КОРОТКИЙ ID вашей доски")
    input("Как будите готовы нажмите ENTER")

    inputed_key = input("Введите ваш Trello API key: ")
    inputed_token = input("Введите ваш Trello API token: ")
    inputed_b_id = input("Введите КОРОТКИЙ id вашей доски: ")
    return inputed_key, inputed_token, inputed_b_id

inputed_key, inputed_token, inputed_b_id = auth_data()
